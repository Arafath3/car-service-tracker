...
export default function LoginScreen() {
  ...
  const handleGuest = () => {
    Alert.alert(
      'Continue as Guest',
      'Your data will be stored only on this device. You can sign up later.',
      [
...
const styles = StyleSheet.create({
  ...
  brandWrap: { alignItems: 'center', marginBottom: theme.spacing.xxxl },
  logoBox: {
